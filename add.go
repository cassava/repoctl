...
func (r *Repo) add(pkgfiles []string, h ErrHandler, ar func(string, string) error, lbl string) error {
	...
	// FIXME:
	//pkgs := r.FindSimilar(added)
	//return r.Dispatch(pkgs.Map(pacman.PkgFilename))
	return nil
}
