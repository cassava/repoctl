...
func (r *Repo) printf(fmt string, obj ...interface{}) {
	if r.Info != nil {
		fmt.Fprintf(r.Info, fmt, obj...)
	}
}

func (r *Repo) errorf(fmt string, obj ...interface{}) {
	if r.Error != nil {
		fmt.Fprintf(r.Error, fmt, obj...)
	}
}

func (r *Repo) debugf(fmt string, obj ...interface{}) {
	if r.Debug != nil {
		fmt.Fprintf(r.Debug, fmt, obj...)
	}
}
